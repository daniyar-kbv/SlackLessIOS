...
struct SummaryScene: DeviceActivityReportScene {
    ...
    let content: ([ActivityReportDay]) -> SummaryRepresentable
    
    func makeConfiguration(representing data: DeviceActivityResults<DeviceActivityData>) async -> [ActivityReportDay] {
